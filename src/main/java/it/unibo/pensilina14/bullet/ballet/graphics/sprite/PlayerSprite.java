...
public class PlayerSprite extends PhysicalObjectSprite {
	...
	public PlayerSprite(final Images img, final MutablePosition2D position, final PhysicalObject physicalObject) throws IOException {
		...
		this.animation = new SpriteAnimation(this.getImageView(), Duration.millis(ANIMATION_TIME), 
				COUNT, COLUMNS, 0, 0, playerViewWidth, playerViewHeight);
	}
