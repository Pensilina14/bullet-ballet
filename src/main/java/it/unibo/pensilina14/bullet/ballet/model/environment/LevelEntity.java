...
/**
 * This enumeration keeps all the entities that could be present inside the game along with their
 * symbol reference written in the map file.
 */
public enum LevelEntity {
  ...
  AMMO('ç'),
  /** Figures a flag {@link Item}. For further reference look into {@link Items#FLAG}. */
  FLAG('F');
  ...
  public final List<LevelEntity> getEntities() {
    return List.of(
        EMPTY, PLATFORM, COIN, OBSTACLE, GUN, SHOTGUN, AUTOGUN, PLAYER, HEART, POISON, DAMAGE,
        ENEMY);
  }
}
