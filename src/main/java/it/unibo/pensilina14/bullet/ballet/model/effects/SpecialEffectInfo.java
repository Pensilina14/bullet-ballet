...
/**
 * A Special Effect differentiates by a simple Effect 
 * thanks to time, in fact they have periodical consequences.
 * Their effect is perpetuated in time so it needs two elements:
 * the step in milliseconds between each perpetuation and 
 * the duration in milliseconds of the whole effect.
 */
