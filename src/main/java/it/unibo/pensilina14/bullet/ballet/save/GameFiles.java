...
public enum GameFiles {
    ...
    SAVE_PATH(USER_HOME_DIRECTORY.getString() + PROJECT_DIRECTORY.getString() + "data/saves/save_file.dat"),
    LEVEL_PATH("data/levels/"),
    SETTINGS_PATH(USER_HOME_DIRECTORY.getString() + PROJECT_DIRECTORY.getString() + "data/settings/settings.dat"),
