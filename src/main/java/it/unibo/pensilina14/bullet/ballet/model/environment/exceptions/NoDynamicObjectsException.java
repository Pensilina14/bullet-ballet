...
/**
 * Checked Exception to be thrown when there are no dynamic objects(they all extend {@link
 * AbstractDynamicComponent}) in a given {@link Environment}.
 */
public class NoDynamicObjectsException extends Exception {
  ...
  /**
   * @param env is the {@link Environment} taken in consideration when the exception is thrown.
   */
