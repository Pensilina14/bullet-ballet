...
public class CollisionEventChecker implements EventChecker {
  ...
  public CollisionEventChecker(
      final List<? extends PhysicalObject> objs, final List<? extends PhysicalObject> otherObjs) {
  ...
  public final void check() {
    final boolean isSingleElemList = this.otherObjects.size() == 1;
