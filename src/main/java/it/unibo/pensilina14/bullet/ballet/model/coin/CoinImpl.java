...
public class CoinImpl extends PickupItem implements Coin {
    ...
    public CoinImpl(final SpeedVector2D speedVector, final Environment gameEnvironment, final double mass, final Dimension2D dimension,
                    final Items itemID, final Effect effect){
        super(speedVector, gameEnvironment, mass, dimension, itemID, effect);
    }
