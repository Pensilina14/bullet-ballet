...
public class EnvironmentGenerator implements LevelGenerator {
  ...
  public final void generate() {
    final EntityManagerBuilder entityManagerBuilder =
        new EntityContainer.Builder(this.env.get().getEntityManager());
  ...
  private void generatePlatform(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addPlatform(
  ...
  private void generateEnemy(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addEnemy(
        this.charactersFactory.createRandomEnemy(
            new SpeedVector2DImpl(new MutablePosition2Dimpl(j * TILE_SIZE, i * TILE_SIZE), 1.0),
            this.env.get()));
  }
  ...
  private void generatePoison(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addItem(
        this.itemFactory.createDamagingItem(
            this.env.get(),
            new SpeedVector2DImpl(new MutablePosition2Dimpl(j * TILE_SIZE, i * TILE_SIZE), 1.0)));
  }

  private void generatePoisoningItem(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addItem(
        this.itemFactory.createPoisoningItem(
            this.env.get(),
            new SpeedVector2DImpl(new MutablePosition2Dimpl(j * TILE_SIZE, i * TILE_SIZE), 1.0)));
  }

  private void generateHealingItem(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addItem(
  ...
  private void generateAmmoItem(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addItem(
        this.itemFactory.createChargerItem(
            this.env.get(),
            new SpeedVector2DImpl(new MutablePosition2Dimpl(j * TILE_SIZE, i * TILE_SIZE), 1.0)));
  }

  private void generateFlagItem(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addItem(
        this.itemFactory.createFlagItem(
            this.env.get(),
            new SpeedVector2DImpl(new MutablePosition2Dimpl(j * TILE_SIZE, i * TILE_SIZE), 1.0)));
  }
  ...
  private void generateAuto(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addWeapon(
        this.weaponFactory.createAuto(
            this.env.get(),
            new SpeedVector2DImpl(new MutablePosition2Dimpl(j * TILE_SIZE, i * TILE_SIZE), 1.0)));
  }

  private void generateShotGun(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addWeapon(
  ...
  private void generateStandardGun(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addWeapon(
  ...
  private void generateStandardObstacle(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addObstacle(
  ...
  private void generateCoin(
      final EntityManagerBuilder entityManagerBuilder, final int i, final int j) {
    entityManagerBuilder.addItem(
        this.itemFactory.createCoinItem(
            this.env.get(),
            new SpeedVector2DImpl(new MutablePosition2Dimpl(j * TILE_SIZE, i * TILE_SIZE), 1.0)));
  }
  ...
  private void generatePlayer(final EntityManagerBuilder e, final int i, final int j) {
    e.addPlayer(
        this.charactersFactory.createRandomPlayer(
            new SpeedVector2DImpl(new MutablePosition2Dimpl(j * TILE_SIZE, i * TILE_SIZE), 2.0),
            this.env.get()));
  }
