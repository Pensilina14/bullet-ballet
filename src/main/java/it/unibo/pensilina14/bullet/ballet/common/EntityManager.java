...
/**
 * Contract for classes that implement {@link AbstractContainer} and have a need to retrieve
 * container content.
 *
 * <p>This is a game-specific interface so it is supposed to give out all the different entities of
 * the game.
 */
public interface EntityManager {
   ...
   *
   * @param enemy
   * @return true if enemy is not yet in the game, false otherwise.
   */
   ...
   *
   * @param item
   * @return true if item is not yet in the game, false otherwise.
   */
   ...
   *
   * @param obstacle
   * @return true if obstacle is not yet in the game, false otherwise.
   */
  boolean addObstacle(Obstacle obstacle);
  /**
   * @param platform indicates the {@link Platform} to be added.
   * @return boolean representing the success of the operation. Unsuccess is guaranteed if platform
   *     is already present.
   */
   ...
   *
   * @param weapon
   * @return true if weapon is not yet in the game, false otherwise.
   */
   ...
   * @return true if entity has been deleted successfully; false if not.
   */
