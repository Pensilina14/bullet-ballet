...
public class ItemFactoryImpl implements ItemFactory {
  ...
  @Override
  public final Item createPoisoningItem(
      final Environment environment, final SpeedVector2D speedVector) {
    return new PickupItem(
        speedVector,
        environment,
        MASS,
        new Dimension2Dimpl(POISONING_ITEM_DIM, POISONING_ITEM_DIM),
        Items.POISON,
  ...
  @Override
  public final Item createHealingItem(
      final Environment environment, final SpeedVector2D speedVector) {
    return new PickupItem(
        speedVector,
        environment,
        MASS,
        new Dimension2Dimpl(HEALING_ITEM_DIM, HEALING_ITEM_DIM),
        Items.HEART,
        effectFact.createHealEffect(Effects.HEALTHY.getDelta().getValue()));
  }

  @Override
  public final Item createDamagingItem(
      final Environment environment, final SpeedVector2D speedVector) {
    return new PickupItem(
        speedVector,
        environment,
        MASS,
        new Dimension2Dimpl(DAMAGING_ITEM_DIM, DAMAGING_ITEM_DIM),
        Items.DAMAGE,
        effectFact.createDamageEffect(Effects.DAMAGE.getDelta().getValue()));
  }
  ...
  public final Item createCoinItem(final Environment environment, final SpeedVector2D speedVector) {
    return new PickupItem(
        ...
        new Dimension2Dimpl(DAMAGING_ITEM_DIM, DAMAGING_ITEM_DIM),
        Items.COIN,
        effectFact.createHealEffect(0));
  }

  @Override
  public final Item createChargerItem(
      final Environment environment, final SpeedVector2D speedVector) {
    return new PickupItem(
        speedVector,
        environment,
        ...
        new Dimension2Dimpl(DAMAGING_ITEM_DIM, DAMAGING_ITEM_DIM),
        Items.CHARGER,
        effectFact.createRechargeEffect());
  }
  ...
  public Item createFlagItem(final Environment environment, final SpeedVector2D speedVector) {
    return new PickupItem(
        ...
        new Dimension2Dimpl(DAMAGING_ITEM_DIM, DAMAGING_ITEM_DIM),
        Items.FLAG,
        effectFact.createDamageEffect(9999.0));
  }
}
