...
/**
 * Contract adhered by classes that need to control the model or bridge communications between
 * another class and the model.
 */
public interface ModelController {
  ...
  /**
   * Simple setter for the {@link GameEventListener} that is going to listen every incoming event
   * from the model.
   *
