...
import it.unibo.pensilina14.bullet.ballet.sounds.SoundImpl;
...
public class SettingsController implements Initializable {
  ...
  public void initialize(
    ...
    if (!settingsMap.isEmpty()) {
      ...
      this.audio.setValue(SoundImpl.DEFAULT_VOLUME);
    }
  }
  ...
  void submitSaveSettings(final MouseEvent event) {
    ...
    if (!(this.resolution.getSelectionModel().getSelectedItem().isBlank()
      ...
      final boolean hasSaved =
          Save.saveSettings(
              Integer.parseInt(resList.get(SettingsController.WIDTH_INDEX)),
              Integer.parseInt(resList.get(SettingsController.HEIGHT_INDEX)),
              this.difficulty.getSelectionModel().getSelectedItem(),
              this.audio.getValue(),
              Languages.valueOf(
                      this.language
                          .getSelectionModel()
