...
//		final Enemy enemy = new Enemy("testEnemy00", 100.0, Optional.ofNullable(150.0), 
//				0, new Dimension2Dimpl(25, 5), null, , 85.0);
//		final PickupItem item = new PickupItem(new Dimension2Dimpl(25, 5),
//				new MutablePosition2Dimpl(150, 50), env, 3.5, t -> t.);
//	}
