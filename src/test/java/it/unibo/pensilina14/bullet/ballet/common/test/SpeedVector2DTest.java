...
public class SpeedVector2DTest {
  ...
  private final SpeedVector2D speedVector =
      new SpeedVector2DImpl(new MutablePosition2Dimpl(POS, POS), SPEED);

  @Test
  public void testNoSpeedVectorSum() {
    final double addictionFactor = 5;
    final MutablePosition2D position =
        new MutablePosition2Dimpl(POS + addictionFactor, POS + addictionFactor);
  ...
  public void testVectorSum() {
    final double addictionFactor = 5;
    final MutablePosition2D position =
        new MutablePosition2Dimpl(POS + (addictionFactor * SPEED), POS + (addictionFactor * SPEED));
