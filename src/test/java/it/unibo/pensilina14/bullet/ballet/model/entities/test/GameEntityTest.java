...
public class GameEntityTest {
  ...
  PhysicalObject gameObject =
      new GameEntity(
          new SpeedVector2DImpl(new MutablePosition2Dimpl(0, 720), 1),
          new GameEnvironment(12, 1883),
          3,
          new Dimension2Dimpl(2, 2));
  ...
  public void testMoveRIGHT() {
    final boolean isStill =
        !gameObject.moveRight(gameObject.getGameEnvironment().get().getDimension().getWidth());
    assertTrue(isStill);
    final boolean isMoving =
        gameObject.moveRight(
            gameObject.getGameEnvironment().get().getDimension().getWidth()
                - this.gameObject.getDimension().get().getWidth());
    assertTrue(isMoving);
  }
  ...
  public void testMoveLEFT() {
    ...
    final boolean isMoving =
        gameObject.moveLeft(testPosition - this.gameObject.getDimension().get().getWidth());
    assertTrue(isMoving);
  }
}
